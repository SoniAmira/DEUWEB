  ...
  <div class="drawer">
    ...
    <div class="content">
      <div class="column">
        ...
        <div class="item">
          <img src="@/assets/ajustes.png" alt="icon" />
          <span
...
<script>
export default {
  // No se necesita data ni script en este caso
};
</script>
...
@media (max-width: 768px) {
  ...
  .content {
    ...
    align-items: flex-start; /* Alinea las columnas a la izquierda en pantallas pequeñas */
  }
}
</style>
